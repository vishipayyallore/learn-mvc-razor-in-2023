...
string serviceName = _configuration["AzureSearchFullTextConfiguration:ServiceName"];
string apiKey = _configuration["AzureSearchFullTextConfiguration:APIKey"];
string indexName = _configuration["AzureSearchFullTextConfiguration:IndexName"];
...
static void WriteDocumentsV1(AutocompleteResults autoResults)
{
